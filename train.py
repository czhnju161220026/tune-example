...
from dlkit_utils import report_final_result, report_intermediate_result, report_loss, get_parameter
...
# Dataroot
parser.add_argument('--dataroot', type=str, default='/workspace/cifar', help="Path to dataset")
